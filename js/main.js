(function () {
  ...
  function searchActive() {
    ...
    searchButton.addEventListener('click', function (e) {
      ...
      if (document.documentElement.clientWidth >= 768 && document.documentElement.clientWidth <= 991 ) {
  ...
  function createSpoiler() {
    ...
    function showActiveCheckbox(element) {
      if (!element) {
        const activeElement = document.querySelector('.edition__checkbox-label_active');
    ...
    function manageCheckbox() {
      const checkboxElements = document.querySelectorAll('.edition__checkbox-label')
  ...
  function initSlider() {
    ...
    document.querySelectorAll('.events__item').forEach(el => el.classList.add('swiper-slide'));
  ...
  function burgerActive() {
    ...
    burger.addEventListener('keydown', function (e) {
      ...
      if (document.documentElement.clientWidth <= 1399 && !this.classList.contains('burger_active')) {
        menuList.forEach(el => {
  ...
  function selectCountry() {
    const listOfCountryEmblems = document.querySelectorAll('.catalog__item-country');
  ...
  function showDropDown() {
    const dropDownList = document.querySelectorAll('.header__secondary-inner-wrapper');
    const listOfHeadings = document.querySelectorAll('.header__secondary-heading');
    let prevTarget = null;
      ...
      el.addEventListener('keydown', function (e) {
        if (e.code === 'Space' || e.code === 'Enter') {
          ...
          if (prevBtn && prevBtn !== e.currentTarget) {
            outerButtons.forEach(el => {
              el.children[0].classList.remove('header__secondary-heading_active')
              el.children[1].hidden = true;
            })
            e.currentTarget.children[0].classList.toggle('header__secondary-heading_active');
  ...
  function addEventsOnInnerButtons() {
    ...
    const innerButtons = document.querySelectorAll('.header__secondary-inner-btn');
    ...
    function openInnerButtonsList() {
      innerButtons.forEach(el => {
        el.addEventListener('keydown', function (e) {
          if ((e.code === 'Space' || e.code === 'Enter') && e.currentTarget !== prevBtn) {
            e.preventDefault()
  ...
  function paintBorder() {
    const accordionWrappers = document.querySelectorAll('.catalog__content-inner-wrapper');
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    const gallreySwiperContainer = document.querySelectorAll('.swiper-container')[1];
    ...
    if (document.documentElement.clientWidth <= 991) {
      document.querySelectorAll('.edition__author')[3].textContent = 'Кричевский, Вла...'
      document.querySelectorAll('.edition__name')[4].textContent = 'Модульные сет...'
      document.querySelectorAll('.edition__author')[4].textContent = 'Мюллер-Брокма...'
      document.querySelectorAll('.edition__name')[5].textContent = 'Эволюция граф...'
      document.querySelectorAll('.edition__name')[6].textContent = 'Искусство и ви...'

    }

    if (document.documentElement.clientWidth >= 576) {

      const editionSwiperContainer = document.querySelectorAll('.swiper-container')[2];
      ...
      document.querySelector('.edition__wrapper-right').classList.remove('swiper-container')
      document.querySelector('.edition__list').classList.remove('swiper-wrapper')
      document.querySelectorAll('.edition__item').forEach(el => el.classList.remove('swiper-slide'))
      document.querySelectorAll('.edition__author')[3].textContent = 'Кричевский, Влади...'
      document.querySelectorAll('.edition__name')[4].textContent = 'Модульные сетки...'
      document.querySelectorAll('.edition__author')[4].textContent = 'Мюллер-Брокманн...'
      document.querySelectorAll('.edition__name')[5].textContent = 'Эволюция графич...'
      document.querySelectorAll('.edition__name')[6].textContent = 'Искусство и визуа...'

    }

    if (document.documentElement.clientWidth >= 576) {
      const projectsSwiperContainer = document.querySelectorAll('.swiper-container')[3];
      ...
      const projectsSwiperContainer = document.querySelectorAll('.swiper-container')[2];
    ...
    const customSectionGalleryOne = document.querySelectorAll('.gallery__select')[0];
    ...
    const customSectionGalleryTwo = document.querySelectorAll('.gallery__select')[1];
    ...
    const customSectionGalleryThree = document.querySelectorAll('.gallery__select')[2];
    ...
    const selectList = document.querySelectorAll('.header__secondary-inner-list');
    selectList.forEach(el => new SimpleBar(el, {
      scrollbarMaxSize: 28,
    }));
    ...
    function accessToButtons() {
      ...
      const activeButton = document.querySelector('.swiper-slide-active .hero__btn')
      buttons.forEach(el => {
        el.setAttribute('tabindex', -1);
      })
    ...
    if (document.documentElement.clientWidth <= 575) {
      initSlider()
      createSpoiler()
      document.querySelector('.active-on-desktop-and-tablet').innerHTML = document.querySelector('.active-on-desktop-and-tablet').innerHTML.replace(/&nbsp;/gi, '')
